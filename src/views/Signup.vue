  ...
  <div id="signup">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-1">
          <i v-if="fullnameAvailable" class="fas fa-check-circle" />
          <i
      ...
      <div class="row">
        ...
        <div class="col-1">
          <i v-if="usernameAvailable" class="fas fa-check-circle" />
          <i
      ...
      <div class="row">
        ...
        <div class="col-1">
          <i v-if="emailAvailable" class="fas fa-check-circle" />
          <i v-else-if="newUser.email.length > 0" class="fas fa-times-circle" />
        </div>
      </div>
      <br />
      <div class="row">
        ...
        <div class="col-1">
          <i v-if="passwordAvailable" class="fas fa-check-circle" />
          <i
      ...
      <div class="row">
        <div class="col">
          <button v-if="submitAvailable" class="btn btn-primary">
            {{ $t("signup.signup") }}
          </button>
...
export default {
  ...
  computed: {
    passwordCheck() {
      ...
      if (this.newUser.passwordFirst == this.newUser.passwordSecond) {
        return true;
      }
      return false;
    },
    submitAvailable() {
      //if 1-2-3-4-at-pwc true
      if (
        this.fullnameAvailable &&
        this.passwordAvailable &&
        this.usernameAvailable &&
        this.emailAvailable &&
        this.passwordCheck &&
        this.newUser.acceptTerms
      ) {
        return true;
      }
      return false;
    ...
    passwordAvailable() {
      //2
      if (
        this.newUser.passwordFirst.length > 7 &&
        !this.newUser.passwordFirst.includes(" ")
      ) {
        return true;
      }
      return false;
    ...
    usernameAvailable() {
      // 3
      if (
        this.newUser.username.length > 2 &&
