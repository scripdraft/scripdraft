...
const messages = {
  en: {
    ...
    workplace: {
      draft: "ScripDraft",
      context:
        "Click commit to save a snapshot of the current text. Then you can use the back and forward buttons to browse among these commits. You may also use the keyboard shortcut Ctrl+Enter to commit.",
      back: "Back",
      commit: "Commit",
      forward: "Forward",
  ...
  tr: {
    ...
    workplace: {
      draft: "ScripDraft",
      context:
        "İşle tuşuna tıklayarak veya Ctrl+Enter ile mevcut metni kaydedin. Geri veya İleri tuşlarıyla bir önceki kayıtlara ulaşabilirsiniz. Tüm kayıtları silmek için Hepsini Sil tuşuna basınız.",
      back: "Geri",
      commit: "İşle",
      forward: "İleri",
