    ...
    <div class="row offset-sm-2 col-sm-8">
      <div class="workplace">
        ...
        <div class="form-group blue-border-focus">
          <label class="instructions" for="textarea1">{{
            $t("workplace.context")
          }}</label>
          <textarea
            id="textarea1"
        ...
        <div id="buttons">
          ...
          <div class="mt-1">
            <b-button-group>
              ...
              <b-button id="clear-button" variant="danger" @click="clearAll">
                {{ $t("workplace.clear") }}
              </b-button>
            </b-button-group>
          </div>
    ...
    <div class="holder row offset-sm-2 col-sm-8">
      ...
      <div class="badges col-6">
        ...
        <span
          ...
          >{{ commit.text }}</span
        >
        <span v-if="isCurrentBadgeAvailable" class="badge badge-success">{{
          allCommits[0].text
        }}</span>
        <span
